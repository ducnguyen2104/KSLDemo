...
-(id)init{
    self = [super init];
    _pipStatus  = @"idle";
    _pipTitle   = [self addLable:@"Picture in Picture Address Documents/movies"];
    ...
    _pipPause   = [self addButton:@"pause"];
    _pipStop    = [self addButton:@"stop"];
    _pipNext    = [self addButton:@"Next video file"];
    _bgpNext    = [self addButton:@"Next background image"];
